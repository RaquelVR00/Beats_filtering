...
for(i in 1:c){
  ...
  #Para obtener finalmente un vector_flags común realizamos un vector_flags_finales
  #el cual tendrá un "1" en aquellas posiciones donde vector_flags (salida de bersnton) o 
  ...
  #El codigo comentado a continuación se usaba para representar usando RHRV
...
name2= paste("Matrices_",change[j],"_V3",".txt",sep="")
