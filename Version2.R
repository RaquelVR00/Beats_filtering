...
#En este caso pasaremos sobre el vector_RR pero guardaremos las flags obtenidas
#en un nuevo vector_flags para que no modifique las flags obtenidas en bernston
...
#Con el fin de obtener un vector_flags común, el cual incluya las vector flags 
#de bernston y las obtenidasen el de deteccion de prematuros:

for(k in 1:(length(vector_flags_finales))){
  if(vector_flags[k]=="1"||vector_flags2[k]=="1"){
...
#La sección siguiente se encargaba de mostrar por pantalla usando RHRV
#por ahora permanece comentada porque sigo trabajando en ella
